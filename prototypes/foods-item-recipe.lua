...
{"fish-salad",						"foods-fish",		5,		0.5,	"advanced-cooking",		1.5,	1,		"w-d-a2",		nil,		{{"tomato", 2}, {"cucumber", 1}, {"lettuce", 4}, {"corn-seeds", 2}, {"cooked-fish-meat", 1},} },
...
-- food capsules
{"food-1-capsule",					"food-capsules",	10,		0.5,	"food-capsules",		12.0,	1,		"w-cb-ai",		nil,		{{"substances-dust", 110}, {"gelatine-granules", 8}} },
{"food-12-capsule",					"food-capsules",	30,		0.5,	"food-capsules",		6.0,	1,		"w-cb-ae",		nil,		{{"substances-dust", 54}, {"gelatine-granules", 3}} },
...
-- effect capsules
{"simple-speed-capsule",			"effect",			100,	0.5,	"crafting",				80.0,	1,		"w-ce-a-aa",	nil,		{{"substance-c", 10}, {"basic-shell-capsule", 1}, {"inserter", 2}} },
{"simple-speed-capsule",			"effect",			100,	0.5,	"crafting",				80.0,	1,		"w-ce-a-ab",	"2",		{{"substance-c", 5}, {"basic-shell-capsule", 1}, {"substance-v", 5}, {"inserter", 2}} },
{"simple-crafting-capsule",			"effect",			100,	0.5,	"crafting",				80.0,	1,		"w-ce-b-aa",	nil,		{{"substance-v", 10}, {"basic-shell-capsule", 1}, {"iron-plate", 4}} },
{"simple-crafting-capsule",			"effect",			100,	0.5,	"crafting",				80.0,	1,		"w-ce-b-ab",	"2",		{{"substance-v", 5}, {"basic-shell-capsule", 1}, {"substance-m", 5}, {"iron-plate", 4}} },
{"simple-mining-capsule",			"effect",			100,	0.5,	"crafting",				80.0,	1,		"w-ce-c-aa",	nil,		{{"substance-c", 10}, {"basic-shell-capsule", 1}, {"iron-plate", 4}} },
{"simple-mining-capsule",			"effect",			100,	0.5,	"crafting",				80.0,	1,		"w-ce-c-ab",	"2",		{{"substance-c", 5}, {"basic-shell-capsule", 1}, {"substance-v", 5}, {"iron-plate", 4}} },
{"simple-long-reach-capsule",		"effect",			100,	0.5,	"crafting",				80.0,	1,		"w-ce-d-aa",	nil,		{{"substance-m", 10}, {"basic-shell-capsule", 1}, {"inserter", 2}} },
-- TODO check capsules
{"basic-speed-capsule",				"effect",			50,		0.5,	"advanced-crafting",	120.0,	1,		"w-ce-a-ba",	nil,		{{"substance-c", 30}, {"advanced-shell-capsule", 1}, {"inserter", 2}} },
{"basic-crafting-capsule",			"effect",			50,		0.5,	"advanced-crafting",	120.0,	1,		"w-ce-b-ba",	nil,		{{"substance-v", 30}, {"advanced-shell-capsule", 1}, {"steel-plate", 2}} },
{"basic-mining-capsule",			"effect",			50,		0.5,	"advanced-crafting",	120.0,	1,		"w-ce-c-ba",	nil,		{{"substance-c", 30}, {"advanced-shell-capsule", 1}, {"steel-plate", 2}} },
{"basic-long-reach-capsule",		"effect",			50,		0.5,	"advanced-crafting",	120.0,	1,		"w-ce-d-ba",	nil,		{{"substance-m", 30}, {"advanced-shell-capsule", 1}, {"long-handed-inserter", 2}} },
...
{"basic-regen-capsule",				"effect",			50,		0.5,	"advanced-cooking",		120.0,	1,		"w-ce-g-ba",	nil,		{{"substance-c", 10}, {"substance-f", 20}, {"advanced-shell-capsule", 1}, {"effectivity-module", 1}, {type="fluid", name="pure-water", amount=60}} },
...
{"basic-health-buffer-capsule",		"effect",			50,		1.6,	"advanced-cooking",		120.0,	1,		"w-ce-h-ba",	nil,		{{"substance-f", 30}, {"advanced-shell-capsule", 1}, {"light-armor", 1}, {type="fluid", name="pure-water", amount=80}} },
...
{"simple-digestive-capsule",		"effect",			100,	0.8,	"cooking",				80.0,	1,		"w-ce-e-aa",	nil,		{{"corn-flour", 2}, {"basic-shell-capsule", 1}, {type="fluid", name="pure-water", amount=10}} },
{"basic-digestive-capsule",			"effect",			50,		0.10,	"advanced-cooking",		120.0,	1,		"w-ce-e-ba",	nil,		{{"corn-flour", 10}, {"advanced-shell-capsule", 1}, {type="fluid", name="pure-water", amount=30}} },
